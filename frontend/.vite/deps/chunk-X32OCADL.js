...
function getColorModeUtils(options = {}) {
  ...
  const utils = {
    ...
    getSystemTheme(fallback) {
      var _a2;
      const dark = (_a2 = utils.query().matches) != null ? _a2 : fallback === "dark";
...
function createContext3(options = {}) {
  ...
  function useContext7() {
    ...
    if (!context && strict) {
      ...
      (_a2 = Error.captureStackTrace) == null ? void 0 : _a2.call(Error, error2, useContext7);
      throw error2;
    }
    return context;
  }
...
function ThemeProvider3(props) {
  ...
  const computedTheme = (0, import_react16.useMemo)(() => toCSSVar(theme), [theme]);
...
function CSSVars({ root = ":host, :root" }) {
  ...
  return (0, import_jsx_runtime3.jsx)(Global, { styles: (theme) => ({ [selector]: theme.__cssVars }) });
}
...
function createIcon(options) {
  ...
  const Comp = forwardRef3((props, ref) => (0, import_jsx_runtime5.jsx)(Icon, { ref, viewBox, ...defaultProps, ...props, children: path.length ? path : (0, import_jsx_runtime5.jsx)("path", { fill: "currentColor", d: pathDefinition }) }));
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-X32OCADL.js.map
