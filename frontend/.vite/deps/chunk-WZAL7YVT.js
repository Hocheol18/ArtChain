...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react3.useMemo)(
    () => shouldWrapChildren ? import_react3.Children.map(children, (child, index) => (0, import_jsx_runtime6.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react4.useMemo)(
  ...
  const clones = (0, import_react4.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react4.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime9.jsxs)(import_react4.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime15.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime15.jsx)(import_react5.Fragment, { children: chunk.text }, index);
  }) });
}
...
//# sourceMappingURL=chunk-WZAL7YVT.js.map
