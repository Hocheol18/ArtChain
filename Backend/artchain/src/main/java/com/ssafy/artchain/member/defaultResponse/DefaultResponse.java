...
public class DefaultResponse<T> {
	...
	public static <T> ResponseEntity<DefaultResponse<T>> toResponseEntity(HttpStatus httpStatus,
																		  com.ssafy.polaris.book.response.StatusCode statusCode, T data) {
	...
	public static <T> ResponseEntity<DefaultResponse<T>> emptyResponse(HttpStatus httpStatus, com.ssafy.polaris.book.response.StatusCode statusCode) {
		return ResponseEntity
			.status(httpStatus)
			.body(DefaultResponse.<T>builder()
				.status(statusCode.getStatus())
