...
import com.ssafy.artchain.settlement.service.SettlemnetService;
...
public class SettlementController {
    ...
    private final SettlemnetService settlemnetService;
    ...
    public ResponseEntity<DefaultResponse<SettlementIdResponseDto>> createSettlementRequest(
        ...
        Long result = settlemnetService.createSettlementRequest(file, dto, member);
    ...
    public ResponseEntity<DefaultResponse<SettlementListResponseDto>> getSettlementRequestList(@AuthenticationPrincipal CustomUserDetails member) {
        List<SettlementListItemDto> settlementList = settlemnetService.getSettlementRequestList(member);
    ...
    public ResponseEntity<DefaultResponse<SettlementResponseDto>> getSettlement(
        ...
        SettlementResponseDto settlementResponseDto = settlemnetService.getSettlement(settlementId, member);
    ...
    public ResponseEntity<DefaultResponse<Void>> updateSettlementStatus(
        ...
        int result = settlemnetService.updateSettlementStatus(settlementId, status, member);
    ...
    public ResponseEntity<DefaultResponse<Void>> deleteSettlement(
        ...
        int result = settlemnetService.deleteSettlement(settlementId, member);
