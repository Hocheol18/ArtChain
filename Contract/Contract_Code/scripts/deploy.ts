...
async function main() {
  ...
  const ArtchainERC20Factory = await ethers.getContractFactory("TokenMarketplace");
  ...
  // const contract = await ArtchainERC20Factory.deploy("FundingTest", "FTC", 10000, 10800);
