...
async function main() {
  ...
  const ArtchainERC20Factory = await ethers.getContractFactory("ReceiveArtCoin");
  const contract = await ArtchainERC20Factory.deploy(10, 100, "0x39af03C99f8b82602d293737dE6A0eBF5d8f48dB");
